 ...
 5f6:	73 18                	jae    610 <free+0x40>
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 24 0a 00 00       	mov    %eax,0xa24
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64d:	a3 24 0a 00 00       	mov    %eax,0xa24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 70f:	89 15 24 0a 00 00    	mov    %edx,0xa24
      return (void*)(p + 1);
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 24 0a 00 00 28 	movl   $0xa28,0xa24
 72d:	0a 00 00 
 730:	c7 05 28 0a 00 00 28 	movl   $0xa28,0xa28
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 28 0a 00 00       	mov    $0xa28,%eax
 73f:	c7 05 2c 0a 00 00 00 	movl   $0x0,0xa2c
 746:	00 00 00 
