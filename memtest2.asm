...
main(int argc, char *argv[])
{
  ...
  11:	68 bb 08 00 00       	push   $0x8bb
  16:	6a 01                	push   $0x1
  18:	e8 f3 04 00 00       	call   510 <printf>
	mem();
...
00000030 <mem>:
{
  ...
  36:	83 ec 14             	sub    $0x14,%esp
	printf(1, "mem test\n");
  39:	68 78 08 00 00       	push   $0x878
  3e:	6a 01                	push   $0x1
  40:	e8 cb 04 00 00       	call   510 <printf>
	m1 = malloc(4096);
  45:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  4c:	e8 1f 07 00 00       	call   770 <malloc>
	if (m1 == 0)
  ...
  92:	e8 79 04 00 00       	call   510 <printf>
	exit();
  97:	e8 f5 02 00 00       	call   391 <exit>
	((int*)m1)[2] = count;
  ...
  c4:	56                   	push   %esi
  c5:	e8 6f 03 00 00       	call   439 <swap>
  ...
  da:	78 48                	js     124 <mem+0xf4>
		wait();
  dc:	e8 b8 02 00 00       	call   399 <wait>
	printf(1, "mem ok %d\n", bstat());
  e1:	e8 4b 03 00 00       	call   431 <bstat>
  e6:	52                   	push   %edx
  e7:	50                   	push   %eax
  e8:	68 a2 08 00 00       	push   $0x8a2
  ed:	6a 01                	push   $0x1
  ef:	e8 1c 04 00 00       	call   510 <printf>
	exit();
  f4:	e8 98 02 00 00       	call   391 <exit>
 ...
 10a:	75 ed                	jne    f9 <mem+0xc9>
		exit();
 10c:	e8 80 02 00 00       	call   391 <exit>
		printf(1, "failed to swap %p\n", start);
 111:	53                   	push   %ebx
 112:	56                   	push   %esi
 113:	68 82 08 00 00       	push   $0x882
 118:	6a 01                	push   $0x1
 ...
 124:	51                   	push   %ecx
 125:	51                   	push   %ecx
 126:	68 95 08 00 00       	push   $0x895
 12b:	6a 01                	push   $0x1
 12d:	e8 de 03 00 00       	call   510 <printf>
 ...
 456:	89 d3                	mov    %edx,%ebx
{
 ...
 499:	0f b6 92 ec 08 00 00 	movzbl 0x8ec(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 694:	eb 1a                	jmp    6b0 <printf+0x1a0>
          s = "(null)";
 696:	bb e3 08 00 00       	mov    $0x8e3,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7f2:	e8 e9 fe ff ff       	call   6e0 <free>
  return freep;
 7f7:	8b 15 e0 0b 00 00    	mov    0xbe0,%edx
