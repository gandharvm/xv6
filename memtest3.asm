...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37f:	f7 f6                	div    %esi
 381:	0f b6 92 20 07 00 00 	movzbl 0x720(%edx),%edx
  }while((x /= base) != 0);
 ...
 3ec:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4f8:	89 45 d0             	mov    %eax,-0x30(%ebp)
          s = "(null)";
 4fb:	b8 17 07 00 00       	mov    $0x717,%eax
...
free(void *ap)
{
 ...
 581:	a1 b4 09 00 00       	mov    0x9b4,%eax
{
 ...
 5a6:	73 18                	jae    5c0 <free+0x40>
{
 ...
 5d7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5d9:	a3 b4 09 00 00       	mov    %eax,0x9b4
}
 5de:	5b                   	pop    %ebx
 5df:	5e                   	pop    %esi
 5e0:	5f                   	pop    %edi
 ...
 5fa:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5fd:	a3 b4 09 00 00       	mov    %eax,0x9b4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 b4 09 00 00    	mov    0x9b4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66f:	76 3f                	jbe    6b0 <malloc+0xa0>
    ...
    if(p == freep)
 671:	39 05 b4 09 00 00    	cmp    %eax,0x9b4
 ...
 696:	e8 e5 fe ff ff       	call   580 <free>
  return freep;
 69b:	8b 15 b4 09 00 00    	mov    0x9b4,%edx
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 b4 09 00 00    	mov    %edx,0x9b4
      return (void*)(p + 1);
 ...
 6d4:	eb e9                	jmp    6bf <malloc+0xaf>
    base.s.ptr = freep = prevp = &base;
 6d6:	c7 05 b4 09 00 00 b8 	movl   $0x9b8,0x9b4
 6dd:	09 00 00 
 6e0:	c7 05 b8 09 00 00 b8 	movl   $0x9b8,0x9b8
 6e7:	09 00 00 
    base.s.size = 0;
 6ea:	b8 b8 09 00 00       	mov    $0x9b8,%eax
 6ef:	c7 05 bc 09 00 00 00 	movl   $0x0,0x9bc
 6f6:	00 00 00 
