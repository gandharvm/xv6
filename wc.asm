...
malloc(uint nbytes)
{
 ...
 7bf:	76 3f                	jbe    800 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	39 05 60 0b 00 00    	cmp    %eax,0xb60
 ...
 7e6:	e8 e5 fe ff ff       	call   6d0 <free>
  return freep;
 7eb:	8b 15 60 0b 00 00    	mov    0xb60,%edx
 ...
 80c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 80f:	89 15 60 0b 00 00    	mov    %edx,0xb60
      return (void*)(p + 1);
 ...
 824:	eb e9                	jmp    80f <malloc+0xaf>
    base.s.ptr = freep = prevp = &base;
 826:	c7 05 60 0b 00 00 64 	movl   $0xb64,0xb60
 82d:	0b 00 00 
 830:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 837:	0b 00 00 
    base.s.size = 0;
 83a:	b8 64 0b 00 00       	mov    $0xb64,%eax
 83f:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 846:	00 00 00 
